Menu, Tray, Icon, C:\WINDOWS\system32\imageres.dll,259 ;Set custom Script icon
 ; changes the icon to a 🚫
...
GroupAdd, altBlocked, ahk_exe winword.exe
GroupAdd, altBlocked, ahk_exe firefox.exe
